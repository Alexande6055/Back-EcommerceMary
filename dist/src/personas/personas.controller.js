...
let PersonasController = class PersonasController {
    ...
    filterPeopleDebtor() {
        return this.personasService.findAllDebtor();
    }
...
__decorate([
    (0, common_1.Get)('filter-people-debtor'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], PersonasController.prototype, "filterPeopleDebtor", null);
__decorate([
    (0, common_1.Patch)('update-peoploe/:id'),
    __param(0, (0, common_1.Param)('id')),
